    ...
    return (
        <footer className='footer'>
            ...
            <div className='footer_container container'>
                ...
                <h1 className='footer_title'>RANJITH KUMAR</h1>
                ...
                <div className="footer_social">
                    ...
                    <a href="https://www.linkedin.com/in/ranjith-kumar-196471197/" className="home_social-icon" rel="noreferrer" target='_blank'>
                        <i className="uil uil-linkedin linked_in f1 f2 icon_size"></i>
                    </a>

                    

                    <a href="https://github.com/Ranjith677" className="home_social-icon" rel="noreferrer" target='_blank'>
                        <i className="uil uil-github github  f1 f3_github icon_size"></i>
                    </a>
                </div>
                <hr className='contact_hr' />
                <span className='footer_copy'>&#169; Copyright 2022. Made by ranjith kumar </span>
            </div>
        </footer>
    )
}
